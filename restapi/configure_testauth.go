...
import (
	...
	"github.com/djarvur/go-mk-ms02-swagger/restapi/operations/auth"
)
...
func configureFlags(api *operations.TestauthAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.TestauthAPI) http.Handler {
